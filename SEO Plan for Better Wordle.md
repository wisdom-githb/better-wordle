...
◦  harder wordle
2. Map them to pages:
◦  / (Home): better wordle, wordle alternative, multi board wordle.
...
•  Canonical and OG/Twitter URLs must use the full GitHub Pages URL with /better-wordle/.
...
•  Keep titles in the pattern: Feature – Better Wordle.
...
◦  “See the global Better Wordle leaderboard” → link to /leaderboard.
...
1. Create robots.txt (in public/ or root, depending on your build setup) so it ends up at /better-wordle/robots.txt:
txt
...
1. Improve README.md:
◦  First line: “Better Wordle is an advanced Wordle-style browser game with multi-board puzzles, marathon, speedrun, and 1v1 modes.”
...
◦  Consider a small “Share Better Wordle” link somewhere visible.
...
◦  Verify <https://YOUR_USERNAME.github.io/better-wordle/>.
...
5. Add a FAQ/help route answering “what/why/how” for Better Wordle.
