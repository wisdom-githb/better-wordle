...
describe('Home', () => {
  it('renders daily boards dropdown with 1–32 options and updates value', () => {
  ...
  it('resets marathon keys and stage indices on reset marathon guesses', () => {
    const setDailyBoards = vi.fn();
  ...
  it('opens verify email modal when SiteHeader sign-up completes', () => {
    const setDailyBoards = vi.fn();
